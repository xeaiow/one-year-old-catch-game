          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="text-accent-foreground drop-shadow-sm">嬰兒抓了什麼 🎯</span>
              </motion.h1>
              <p className="text-muted-foreground text-sm sm:text-base mt-2">
                {isItemsComplete ? '選擇完成！點擊揭曉結果' : `選擇嬰兒抓的 ${MAX_SELECTIONS} 個物品`}
              </p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 mt-3">
                <span className="text-muted-foreground text-sm sm:text-base">嬰兒抓了：</span>
